...
const driversData = {
  'DRV-001': { id: 'DRV-001', name: 'John Tembo', avatarUrl: 'https://placehold.co/100x100/34D399/1C252D?text=JT', status: 'Available' as const, phone: '+260977123456', rating: 4.9, totalDeliveries: 152, memberSince: '2022-08-15', totalPayout: 22800, cancelledDeliveries: 5 },
  'DRV-002': { id: 'DRV-002', name: 'Maria Phiri', avatarUrl: 'https://placehold.co/100x100/34D399/1C252D?text=MP', status: 'Busy' as const, currentOrderId: 'ORD-002', phone: '+260977234567', rating: 4.8, totalDeliveries: 210, memberSince: '2021-11-20', totalPayout: 35700, cancelledDeliveries: 10 },
  'DRV-003': { id: 'DRV-003', name: 'David Banda', avatarUrl: 'https://placehold.co/100x100/34D399/1C252D?text=DB', status: 'Busy' as const, currentOrderId: 'ORD-005', phone: '+260977345678', rating: 4.9, totalDeliveries: 180, memberSince: '2022-01-10', totalPayout: 28800, cancelledDeliveries: 8 },
  'DRV-004': { id: 'DRV-004', name: 'Grace Zulu', avatarUrl: 'https://placehold.co/100x100/34D399/1C252D?text=GZ', status: 'Available' as const, phone: '+260977456789', rating: 4.7, totalDeliveries: 95, memberSince: '2023-03-05', totalPayout: 13205, cancelledDeliveries: 12 },
  'DRV-005': { id: 'DRV-005', name: 'Peter Mwale', avatarUrl: 'https://placehold.co/100x100/34D399/1C252D?text=PM', status: 'Available' as const, phone: '+260977567890', rating: 5.0, totalDeliveries: 320, memberSince: '2020-05-25', totalPayout: 54400, cancelledDeliveries: 3 },
  'DRV-006': { id: 'DRV-006', name: 'Charity Sakala', avatarUrl: 'https://placehold.co/100x100/34D399/1C252D?text=CS', status: 'Busy' as const, currentOrderId: 'ORD-001', phone: '+260977678901', rating: 4.8, totalDeliveries: 115, memberSince: '2022-10-30', totalPayout: 17825, cancelledDeliveries: 6 },
};

const fullHistory = [
    { id: 'LSK-HIST-001', destination: 'Taj Pamodzi Hotel', payout: 185.25, date: 'Yesterday', status: 'Delivered' as const },
    { id: 'LSK-HIST-003', destination: 'Manda Hill Mall', payout: 75.50, date: '2 days ago', status: 'Delivered' as const },
    { id: 'LSK-HIST-004', destination: 'University of Zambia', payout: 120.00, date: '2 days ago', status: 'Cancelled' as const },
    { id: 'LSK-HIST-005', destination: 'Levy Junction Mall', payout: 65.00, date: '3 days ago', status: 'Delivered' as const },
    { id: 'LSK-HIST-006', destination: 'Soweto Market', payout: 115.75, date: '4 days ago', status: 'Delivered' as const },
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-3">
                ...
                <CardHeader className="flex flex-row items-center space-x-4">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mt-2">
                             <Badge
                              className={cn(
                                driverData.status === 'Available' && 'bg-green-500/20 text-green-400 border-green-500/30',
                                driverData.status === 'Busy' && 'bg-red-500/20 text-red-400 border-red-500/30'
                              )}
                              variant="outline"
                            >
                              {driverData.status}
          ...
          <div className="space-y-6">
              {driverData.status === 'Busy' && driverData.currentOrderId && (
                  <Card className="w-full shadow-md">
                      <CardHeader>
                          <CardTitle className="flex items-center">
